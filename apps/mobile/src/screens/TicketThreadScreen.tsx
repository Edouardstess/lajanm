...
const styles = StyleSheet.create({
  ...
  subject: { flex: 1, fontSize: typography.heading, fontFamily: fonts.bold, color: colors.text, letterSpacing: -0.2 },
  statusPill: {
  ...
  sender: { fontSize: typography.overline, fontFamily: fonts.semibold, color: colors.muted, marginBottom: spacing.xs },
  senderSupport: { color: colors.primary },
  body: { fontSize: typography.label, fontFamily: fonts.regular, color: colors.text, lineHeight: 23 },
  time: { fontSize: 11, fontFamily: fonts.regular, color: colors.muted, marginTop: spacing.sm - 2 },
