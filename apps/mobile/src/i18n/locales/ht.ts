...
export default {
  ...
  kyc: {
    ...
    uploading: 'N ap voye foto a...',
    photo_accepted: 'Foto a resevwa',
    upload_failed: 'Nou pa ka voye foto a. Eseye ankò.',
    unsupported_file: 'Se sèlman foto JPG, PNG oswa WEBP nou aksepte.',
  ...
  wallet: {
    ...
    recipient_hint: 'Nimewo telefòn Lajan’m moun nan',
    recipient_checking: 'N ap chèche moun nan...',
    recipient_found: 'W ap voye bay',
    recipient_unknown: 'Nimewo sa a pa gen kont Lajan’m',
    recipient_unnamed: 'Yon kont Lajan’m',
    amount_label: 'Montan an (HTG)',
