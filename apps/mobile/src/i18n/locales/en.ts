export default {
  ...
  auth: {
    ...
    pin_hint: 'Choose a code only you know. Avoid your date of birth.',
  ...
  kyc: {
    ...
    photo_accepted: 'Photo received',
    upload_failed: 'Could not upload the photo. Try again.',
    unsupported_file: 'Only JPG, PNG or WEBP photos are accepted.',
  ...
  profile: {
    ...
    devices_empty: 'No other connected device',
  ...
  topup: {
    ...
    safety: 'You will never type your MonCash code into Lajan’m',
  },
  wallet: {
    ...
    recipient_hint: 'The recipient’s Lajan’m number',
    recipient_checking: 'Looking up recipient...',
    recipient_found: 'You are sending to',
    recipient_unknown: 'This number has no Lajan’m account',
    recipient_unnamed: 'A Lajan’m account',
    amount_label: 'Amount (HTG)',
    ...
    greeting: 'Hello',
    see_all: 'All',
    transfer_safety: 'We will ask you for a code before sending',
    type_topup: 'Top-up',
    type_payout: 'Payout',
  ...
  payout: {
    ...
    safety: 'The money will go to your MonCash account',
    amount_label: 'Amount (HTG)',
